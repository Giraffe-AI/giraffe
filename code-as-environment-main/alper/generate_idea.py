...
'''
TODO:
    - Improve automatic image asset retrieval. Bing's image retrieval is not great. Here are some possible ideas
        - Prompt better
        - Get 10 images per query and use something like CLIP to find the best one
    - Find a way to incorporate the images into game generation stage (could be during or after generation).
        One or the other may hurt the model's performance.
'''
