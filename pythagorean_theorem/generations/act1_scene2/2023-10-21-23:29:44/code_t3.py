...
class HistoricalBackground(Scene):
    def construct(self):
        # Create elements
        greece = ImageMobject("/absolute/path/to/ancient_greece.jpg").scale(0.5)
        pythagoras = ImageMobject("/absolute/path/to/pythagoras.jpg").scale(0.2)
        students = ImageMobject("/absolute/path/to/students.jpg").scale(0.2)
