...
class HistoricalBackground(Scene):
    def construct(self):
        # Create elements
        greece = ImageMobject("/correct/path/to/ancient_greece.jpg").scale(0.5)
        pythagoras = ImageMobject("/correct/path/to/pythagoras.jpg").scale(0.2)
        students = ImageMobject("/correct/path/to/students.jpg").scale(0.2)
