...
class HistoricalBackground(Scene):
    def construct(self):
        # Create elements
        greece = ImageMobject("/path/to/ancient_greece.jpg").scale(0.5)
        pythagoras = ImageMobject("/path/to/pythagoras.jpg").scale(0.2)
        students = ImageMobject("/path/to/students.jpg").scale(0.2)
